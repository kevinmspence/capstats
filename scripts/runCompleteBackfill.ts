...
class HistoricalDataService {
  // Updated to use the actual MoneyPuck CSV URL structure
  private readonly MONEYPUCK_CSV_BASE = 'https://moneypuck.com/moneypuck/playerData/seasonSummary';
  private readonly NHL_SEASONS_START = 2008; // MoneyPuck has data from 2008-2009 onwards
  ...
  private async fetchSeasonData(season: HistoricalSeason) {
    ...
    try {
      ...
      // Use the actual MoneyPuck CSV URL structure we discovered
      ...
      // Fetch each type of data using the correct URLs
